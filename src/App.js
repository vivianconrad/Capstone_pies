...
const DATA = [
    { id: "todo-0", name: "Eat", completed: true, category: "Personal", priority: "priority0"},
    { id: "todo-1", name: "Sleep", completed: false, category: "Learning", priority: "priority1" },
    { id: "todo-2", name: "Repeat", completed: false, category: "Work", priority: "priority3" }
];
...
function App(props) {
    ...
    let taskList = tasks.filter(FILTER_MAP[filter]).map(task => (
        <Todo
            id={task.id}
            name={task.name}
